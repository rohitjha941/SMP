            ...
            <React.Fragment>
                <div className={styles.mainDiv}>
                    <div className={styles.mainImageDiv}>
                        <img className={styles.mainImage} src={this.state.blogData.imgSrc} alt={this.state.blogData.imgAlt || this.state.blogData.Title}/>
                    </div>
                    <div className={styles.contentDiv}>
                        ...
                        <div className={styles.metadata}>
                            {this.state.blogData.metadata ? (this.state.blogData.metadata.d1+' • '+this.state.blogData.metadata.d2+' • '+this.state.blogData.metadata.d3) : null}
                        </div>
                        <div className={styles.blogText}>
                            <div dangerouslySetInnerHTML={{__html:this.state.blogData.text}}></div>
                        </div>
