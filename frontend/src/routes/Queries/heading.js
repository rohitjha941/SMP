    ...
    return (
      <div className={styles.headingParentDiv}>
        ...
        <div className={styles.toggleParentDiv}>
          <Button
            onClick={() => this.toggleBtn("mentor")}
            className={styles.mentorMenteeButton}
            text="Mentor"
            type={this.state.mentorActiveStatus}
          />
          <span className={styles.bar}></span>
          <Button
            onClick={() => this.toggleBtn("mentee")}
            className={styles.mentorMenteeButton}
            type={this.state.menteeActiveStatus}
            text="Mentee"
          />
        </div>
      </div>
