                ...
                <div className={styles.mainWrapper}>
                    <div className={styles.mainContent}>
                        ...
                        <div className={styles.Text}>
                            <div className={styles.Error404}>Error <span className={'color-red '+styles.redText}>404</span></div>
                            <div className={styles.PageNotFound}>Page Not Found!</div>
                            <Link to="/" >
                                <Button type='solid' text='Return to Home Page' className={styles.button}/>
                            </Link>
                        </div>
                    </div>
                </div>
