...
function WrappedComponent(props) {
  ...
  const imageAlternativeText = props.eventData.imgAlt
    ? props.eventData.imgAlt
    : props.eventData.heading;
  const heading =
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <img
          className={
            props.type === "side" ? styles.sideViewImg : styles.eventImage
          }
          src={imageSource}
